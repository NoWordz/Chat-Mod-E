...
public class ChatMessageStore {
    ...
    // Same reason: the server backlog merge consults the block list per row.
    public static java.util.function.Supplier<List<? extends String>> blockedPlayersSupplier =
    ...
    public static void addHistoryMessages(List<com.niuqu.chatbubble.packets.HistoryPayload.HistoryEntry> entries) {
        ...
        for (var e : entries) {
            ...
            if (BlockList.isPlayerBlocked(sender, Component.literal(sender),
                blockedPlayersSupplier.get())) continue;
